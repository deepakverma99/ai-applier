...
// Helper Functions
async function updateApplicationStatus(id, status, message) {
...
async function emitSocketEvent(userId, event, data) {
    // Placeholder for Socket.io integration
    console.log(`Socket event to ${userId}: ${event}`, data);
}
async function getAndDecryptCredentials(credentialId) {
...
const worker = new Worker('job-applications', async (job) => {
